...
// 		frappe.xcall("cre.cre.page.console.console.get_console_config").then(config => {
...
// 			frappe.set_route("console", this.options.selected_doctype);
// 			this.make_request();
// 		});
// 	}
...
class JMGListView extends frappe.views.BaseList {
	static load_last_view() {
		const route = frappe.get_route();
		const doctype = 'Lead'
		console.log(route, doctype);
