(() => {
  // ../cre/cre/public/frappe/frappe/public/js/bootstrap-4-web.bundle.js
  ...
  frappe.ui.Dialog = class Dialog extends frappe.ui.Dialog {
    ...
    set_primary_action(label, click) {
      ...
      return super.set_primary_action(label, click).removeClass("invisible");
    }
    make() {
      super.make();
      if (this.fields) {
...
//# sourceMappingURL=bootstrap-4-web.bundle.5RVJXNDA.js.map
