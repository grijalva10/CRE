...
def get_context(context):
    ...
    context.project = frappe.get_doc('Project', context.doc.project).as_dict()
    context.project_todos = frappe.get_list('ToDo', filter={'reference_name': context.project.name, 'reference_type': 'Project'}) 

    
    context.comments =  frappe.get_all('Comment', filters={'reference_name': context.doc.name, 'reference_doctype': context.doctype, 'comment_type': 'Comment'}, fields=['*'])
